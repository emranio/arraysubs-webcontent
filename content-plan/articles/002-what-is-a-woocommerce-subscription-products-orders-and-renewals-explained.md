...
- **Recommended URL:** `/deals/arraysubs/resources/subscription-foundations/what-is-a-woocommerce-subscription-products-orders-and-renewals-explained/`
...
- WooCommerce subscription meaning
- subscription product vs subscription order
- how recurring orders work in WooCommerce

## Goal

Rank and earn AI citations for “what is a WooCommerce subscription,” fully resolve the searcher's task, and establish ArraySubs authority in subscription foundations.
...
1. A 40-60 word standalone definition
2. Subscription product, customer agreement, parent order, and renewal order
3. Lifecycle timeline from checkout to renewal or cancellation
4. Automatic versus manual payment at a glance
5. Worked example and common terminology mistakes
...
Use current WooCommerce entity names and distinguish a product configuration from a customer's subscription record.

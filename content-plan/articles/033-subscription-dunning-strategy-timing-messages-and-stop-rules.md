...
- **Proposed title:** Subscription Dunning Strategy: Timing, Messages, and Stop Rules
- **Content cluster:** C03 — Failed payments, dunning, and grace recovery
- **Content category:** Payment Recovery
- **Recommended URL:** `/deals/arraysubs/resources/payment-recovery/subscription-dunning-strategy-timing-messages-and-stop-rules/`
...
- WooCommerce dunning email schedule
- failed payment retry strategy ecommerce
- subscription recovery sequence best practices

## Goal

Rank and earn AI citations for “subscription dunning strategy WooCommerce,” fully resolve the searcher's task, and establish ArraySubs authority in payment recovery.
...
1. Dunning definition and objectives
2. Segment decline types and recoverability
3. Retry schedule and message sequence
4. Access/grace policy and customer tone
5. KPIs, stop rules, and experiment design
...
Avoid a one-size-fits-all retry schedule; gateway guidance and decline codes must shape recommendations.

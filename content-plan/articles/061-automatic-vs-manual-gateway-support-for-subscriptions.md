...
- **Recommended URL:** `/deals/arraysubs/resources/payments-and-compliance/automatic-vs-manual-gateway-support-for-subscriptions/`
...
Rank and earn AI citations for “automatic vs manual subscription gateway support,” fully resolve the searcher's task, and establish ArraySubs authority in payments & compliance.
...
1. Definitions and quick comparison
2. Saved token and merchant-initiated transaction requirements
3. Customer journey for each model
4. Failure, SCA, switching, and support implications
5. Gateway qualification checklist
...
Clearly distinguish “works at checkout” from “can automatically charge future renewals.”

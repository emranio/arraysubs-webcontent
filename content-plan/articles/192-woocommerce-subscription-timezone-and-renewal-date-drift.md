...
- **Proposed title:** WooCommerce Subscription Timezone and Renewal-Date Drift
- **Content cluster:** C15 — Troubleshooting, infrastructure, and developer operations
- **Content category:** Technical Operations
- **Recommended URL:** `/deals/arraysubs/resources/technical-operations/woocommerce-subscription-timezone-and-renewal-date-drift/`
- **Search intent:** Troubleshooting
- **Funnel stage:** Interest
- **Priority:** P0 · Wave 2
- **Content format:** Troubleshooting guide
- **Estimated size:** 1,800-2,800 words
- **Focus keyword:** WooCommerce subscription renewal date timezone

### Long-tail keywords

- subscription renews wrong time WooCommerce
- WordPress UTC site timezone recurring payments
- renewal date drift daylight saving

## Goal

Become the practical diagnostic result for “WooCommerce subscription renewal date timezone,” reduce time-to-resolution, and demonstrate ArraySubs' operational depth.
...
1. Stored UTC, site timezone, display timezone, and gateway timestamp concepts
2. Daylight-saving and month-end edge cases
3. Sync, proration, manual edits, and clone causes
4. Build an event timeline across systems
5. Safe correction and regression tests
...
Use shared date-formatting helpers only for display in ArraySubs; scheduling logic must use raw times/timestamps as designed.

create all the pages (except blogs) including all refund policies, privacy policy data policy homepage, feature page, inner feature page, pricing page etc, all all.
homepage >> redirects to arraysubs page/
pricing page >> shows a cta get the pro for free, feature comparisn with free and pro. 
contact page, policy page etc will be for arrayhash [the company]. 
user documentions url >> https://support.arrayhash.com/arraysubs/
make sure, to optimize the page for effective SEO, GEO and google lighthouse pagespeed score, good accissiblity score. and most importanbtly, high conversion optimized attaintion grab layout.
use sections from design system, page. 
first create a list of pages with url/ slug design. then start create one by one.
---
u can find contents and copies from marketing materials. << use these as reference. u can optimize the content as u see fit. 

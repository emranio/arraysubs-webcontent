...
- **Proposed title:** Store Credit vs Cash Refund: A Decision Framework
- **Content cluster:** C09 — Store credit, refunds, and loyalty value
- **Content category:** Store Credit & Loyalty
- **Recommended URL:** `/store-credit-and-loyalty/store-credit-vs-cash-refund-a-decision-framework/`
- **Search intent:** Commercial investigation
- **Funnel stage:** Consideration
- **Priority:** P2 · Wave 3
- **Content format:** Comparison
- **Estimated size:** 3,000-4,200 words
- **Focus keyword:** store credit vs cash refund

### Long-tail keywords

- refund to store credit pros and cons
- WooCommerce credit refund policy
- cash refund or account credit ecommerce

## Goal

Earn decision-stage visibility for “store credit vs cash refund,” help readers make a defensible choice, and move qualified evaluators toward ArraySubs without hiding tradeoffs.
...
1. Customer-rights and merchant-objective framing
2. Liquidity, fees, retention, satisfaction, and accounting tradeoffs
3. When credit should never be forced
4. Incentive and expiration considerations
5. Decision tree and policy checklist
...
General information only. Refund rights vary; never recommend withholding a legally required original-method refund.

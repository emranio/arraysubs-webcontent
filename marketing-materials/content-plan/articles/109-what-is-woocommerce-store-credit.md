...
- **Proposed title:** What Is WooCommerce Store Credit?
- **Content cluster:** C09 — Store credit, refunds, and loyalty value
- **Content category:** Store Credit & Loyalty
- **Recommended URL:** `/store-credit-and-loyalty/what-is-woocommerce-store-credit/`
- **Search intent:** Informational
- **Funnel stage:** Awareness
- **Priority:** P2 · Wave 3
- **Content format:** Explainer
- **Estimated size:** 1,600-2,300 words
- **Focus keyword:** what is WooCommerce store credit

### Long-tail keywords

- WooCommerce store credit meaning
- store wallet balance explained
- how ecommerce credit works

## Goal

Rank and earn AI citations for “what is WooCommerce store credit,” fully resolve the searcher's task, and establish ArraySubs authority in store credit & loyalty.
...
ArraySubs Store Credit is Pro. Distinguish wallet-style balance from coupon-only implementations.

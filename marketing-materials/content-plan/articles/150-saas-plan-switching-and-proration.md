...
- **Proposed title:** SaaS Plan Switching and Proration
- **Content cluster:** C12 — SaaS, digital products, entitlements, and usage billing
- **Content category:** SaaS & Digital Products
- **Recommended URL:** `/saas-and-digital-products/saas-plan-switching-and-proration/`
- **Search intent:** Informational
- **Funnel stage:** Consideration
- **Priority:** P1 · Wave 3
- **Content format:** Guide
- **Estimated size:** 2,400-3,200 words
- **Focus keyword:** SaaS plan switching proration WooCommerce

### Long-tail keywords

- upgrade downgrade SaaS subscription
- feature entitlement changes during plan switch
- prorate annual monthly plan change

## Goal

Rank and earn AI citations for “SaaS plan switching proration WooCommerce,” fully resolve the searcher's task, and establish ArraySubs authority in saas & digital products.
...
1. Upgrade, downgrade, crossgrade, and cadence-change cases
2. Immediate versus renewal-effective access
3. Charge, credit, defer, and no-proration options
4. Usage-limit and data-retention effects
5. Customer preview, audit, and test matrix
...
Link to ArraySubs plan-switching/proration recipes and verify current core/Pro boundaries.

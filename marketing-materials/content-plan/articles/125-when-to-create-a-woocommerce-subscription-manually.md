...
- **Proposed title:** When to Create a WooCommerce Subscription Manually
- **Content cluster:** C10 — Customer portal, self-service, and admin operations
- **Content category:** Customer & Admin Operations
- **Recommended URL:** `/deals/arraysubs/resources/customer-and-admin-operations/when-to-create-a-woocommerce-subscription-manually/`
- **Search intent:** Informational
- **Funnel stage:** Interest
- **Priority:** P1 · Wave 3
- **Content format:** Guide
- **Estimated size:** 2,400-3,200 words
- **Focus keyword:** create WooCommerce subscription manually use cases

### Long-tail keywords

- admin add subscription for customer
- phone order recurring subscription
- manual subscription migration use cases

## Goal

Rank and earn AI citations for “create WooCommerce subscription manually use cases,” fully resolve the searcher's task, and establish ArraySubs authority in customer & admin operations.
...
1. Legitimate service, migration, replacement, and recovery use cases
2. Consent, customer, product, price, dates, tax, and gateway prerequisites
3. Parent order and payment considerations
4. Audit, notification, and review controls
5. Postcreation validation checklist
...
- Related briefs:
  ...
  - A127 — WooCommerce Subscription Export and Data Governance
...
Do not treat manual creation as a shortcut around payment authorization or consent.

...
- **Proposed title:** Pause vs Cancel: Designing a Subscription Vacation Policy
- **Content cluster:** C06 — Retention, churn, and cancellation flows
- **Content category:** Retention & Churn
- **Recommended URL:** `/deals/arraysubs/resources/retention-and-churn/pause-vs-cancel-designing-a-subscription-vacation-policy/`
- **Search intent:** Informational
- **Funnel stage:** Consideration
- **Priority:** P0 · Wave 1
- **Content format:** Comparison
- **Estimated size:** 3,000-4,200 words
- **Focus keyword:** pause vs cancel subscription

### Long-tail keywords

- subscription pause policy best practices
- vacation mode recurring subscription
- when to offer pause instead of cancellation

## Goal

Rank and earn AI citations for “pause vs cancel subscription,” fully resolve the searcher's task, and establish ArraySubs authority in retention & churn.
...
1. Customer and business differences
2. Pause length, frequency, and eligibility
3. Billing, access, fulfillment, and communication behavior
4. Abuse and reactivation controls
5. Policy template and metrics
...
The existing pause-offer recipe owns ArraySubs configuration.

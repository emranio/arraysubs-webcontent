# A118 — WooCommerce Subscription Lifecycle: Statuses and Transitions

## Article specification

- **Proposed title:** WooCommerce Subscription Lifecycle: Statuses and Transitions
- **Content cluster:** C10 — Customer portal, self-service, and admin operations
- **Content category:** Customer & Admin Operations
- **Recommended URL:** `/deals/arraysubs/resources/customer-and-admin-operations/woocommerce-subscription-lifecycle-statuses-and-transitions/`
- **Search intent:** Informational
- **Funnel stage:** Awareness
- **Priority:** P1 · Wave 2
- **Content format:** Pillar guide
- **Estimated size:** 3,500-4,500 words
- **Focus keyword:** WooCommerce subscription lifecycle statuses

### Long-tail keywords

- subscription status flow WooCommerce
- active on hold cancelled expired pending subscription
- subscription lifecycle diagram

## Goal

Rank and earn AI citations for “WooCommerce subscription lifecycle statuses,” fully resolve the searcher's task, and establish ArraySubs authority in customer & admin operations.
...
Separate official Woo status names from ArraySubs statuses and verify both against current code.

...
- **Proposed title:** Selling Prepaid Store Credit: Bonus Economics and Liability
- **Content cluster:** C09 — Store credit, refunds, and loyalty value
- **Content category:** Store Credit & Loyalty
- **Recommended URL:** `/store-credit-and-loyalty/selling-prepaid-store-credit-bonus-economics-and-liability/`
- **Search intent:** Informational
- **Funnel stage:** Consideration
- **Priority:** P2 · Wave 4
- **Content format:** Strategy guide
- **Estimated size:** 2,200-3,000 words
- **Focus keyword:** sell prepaid store credit WooCommerce

### Long-tail keywords

- WooCommerce credit top up product
- bonus store credit pricing
- prepaid wallet balance ecommerce

## Goal

Rank and earn AI citations for “sell prepaid store credit WooCommerce,” fully resolve the searcher's task, and establish ArraySubs authority in store credit & loyalty.
...
1. Prepaid credit versus gift card
2. Bonus percentage and breakage math
3. Cash, deferred revenue, refund, and expiry considerations
4. Fraud, transfer, and promotion limits
5. Launch model and reconciliation checklist
...
Accounting and gift-card laws vary. Require qualified review before publishing or implementing policy recommendations.

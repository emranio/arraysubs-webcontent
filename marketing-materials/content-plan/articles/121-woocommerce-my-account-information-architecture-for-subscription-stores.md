# A121 — WooCommerce My Account Information Architecture for Subscription Stores

## Article specification

- **Proposed title:** WooCommerce My Account Information Architecture for Subscription Stores
- **Content cluster:** C10 — Customer portal, self-service, and admin operations
- **Content category:** Customer & Admin Operations
- **Recommended URL:** `/customer-and-admin-operations/woocommerce-my-account-information-architecture-for-subscription-stores/`
- **Search intent:** Informational
- **Funnel stage:** Interest
- **Priority:** P1 · Wave 2
- **Content format:** Guide
- **Estimated size:** 2,400-3,200 words
- **Focus keyword:** WooCommerce My Account subscription information architecture

### Long-tail keywords

- customize My Account subscription navigation
- member portal menu structure
- subscription account page UX

## Goal

Rank and earn AI citations for “WooCommerce My Account subscription information architecture,” fully resolve the searcher's task, and establish ArraySubs authority in customer & admin operations.
...
1. Jobs-to-be-done inventory
2. Navigation for plans, orders, payments, credit, profile, downloads, and support
3. Prioritization by role and status
4. Mobile, accessibility, empty, and error states
5. Card-sorting and usability-test plan
...
Link to My Account recipes for configuration. Verify which builder functions are Free versus Pro.

...
- **Proposed title:** Store Credit Expiration Policy: UX, Accounting, and Compliance
- **Content cluster:** C09 — Store credit, refunds, and loyalty value
- **Content category:** Store Credit & Loyalty
- **Recommended URL:** `/store-credit-and-loyalty/store-credit-expiration-policy-ux-accounting-and-compliance/`
- **Search intent:** Informational
- **Funnel stage:** Interest
- **Priority:** P2 · Wave 4
- **Content format:** Guide
- **Estimated size:** 2,400-3,200 words
- **Focus keyword:** store credit expiration policy

### Long-tail keywords

- can WooCommerce store credit expire
- customer credit expiry best practices
- store wallet expiration email

## Goal

Rank and earn AI citations for “store credit expiration policy,” fully resolve the searcher's task, and establish ArraySubs authority in store credit & loyalty.
...
1. Types and sources of credit
2. Business reason versus customer harm
3. Notice cadence and accessible balance display
4. Accounting, abandoned-property, and jurisdictional questions
5. Policy checklist and exception process
...
- Related briefs:
  ...
  - A115 — Reconciling Store Credit Balances and Transaction History
...
General information, not legal or accounting advice. Some credit cannot legally expire in some jurisdictions.

# A076 — How Much Discount Should a Cancellation Offer Give?

## Article specification

- **Proposed title:** How Much Discount Should a Cancellation Offer Give?
- **Content cluster:** C06 — Retention, churn, and cancellation flows
- **Content category:** Retention & Churn
- **Recommended URL:** `/deals/arraysubs/resources/retention-and-churn/how-much-discount-should-a-cancellation-offer-give/`
- **Search intent:** Informational
- **Funnel stage:** Consideration
- **Priority:** P0 · Wave 1
- **Content format:** Calculator guide
- **Estimated size:** 1,800-2,600 words
- **Focus keyword:** cancellation offer discount amount

### Long-tail keywords

- subscription retention discount percentage
- save offer discount economics
- how to calculate churn discount

## Goal

Rank and earn AI citations for “cancellation offer discount amount,” fully resolve the searcher's task, and establish ArraySubs authority in retention & churn.
...
1. Discount versus expected retained margin
2. Break-even and payback formulas
3. Tenure, plan, reason, and LTV segmentation
4. Duration, stacking, and repeat-use controls
5. Worked examples and experiment stop rules
...
- Related briefs:
  - A075 — Cancellation Survey Questions That Produce Useful Data
  - A077 — Pause vs Cancel: Designing a Subscription Vacation Policy
  - A078 — Downgrade vs Cancel: Retaining Customers at a Better-Fit Tier
...
Use transparent formulas and hypothetical examples; do not publish invented conversion lifts.

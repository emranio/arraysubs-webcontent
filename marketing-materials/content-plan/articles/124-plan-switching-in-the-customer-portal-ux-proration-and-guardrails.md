# A124 — Plan Switching in the Customer Portal: UX, Proration, and Guardrails

## Article specification

- **Proposed title:** Plan Switching in the Customer Portal: UX, Proration, and Guardrails
- **Content cluster:** C10 — Customer portal, self-service, and admin operations
- **Content category:** Customer & Admin Operations
- **Recommended URL:** `/deals/arraysubs/resources/customer-and-admin-operations/plan-switching-in-the-customer-portal-ux-proration-and-guardrails/`
- **Search intent:** Informational
- **Funnel stage:** Consideration
- **Priority:** P1 · Wave 3
- **Content format:** Guide
- **Estimated size:** 2,400-3,200 words
- **Focus keyword:** customer portal subscription plan switching

### Long-tail keywords

- self service upgrade downgrade WooCommerce
- subscription switch UX best practices
- plan change proration portal

## Goal

Rank and earn AI citations for “customer portal subscription plan switching,” fully resolve the searcher's task, and establish ArraySubs authority in customer & admin operations.
...
Create a guide for support teams, subscription administrators, and customer-experience leaders. Help operators design lower-support lifecycle workflows and reliable subscription administration. Lead with a self-contained 40-60 word answer, then add original analysis, worked examples, or a decision framework that a generic roundup cannot reproduce. Keep education independent from product promotion and identify where ArraySubs is not the best fit.

### Recommended outline

1. Eligible source and destination plans
2. Price, feature, date, and proration preview
3. Immediate versus renewal-effective choice
4. Confirmation, undo, and failed-payment handling
5. Analytics and support checklist
...
- [WooCommerce customer subscription management](https://woocommerce.com/document/subscriptions/customers-view/)
- [WooCommerce add or modify subscriptions](https://woocommerce.com/document/subscriptions/add-or-modify-a-subscription/)
- [Woo self-service dashboard](https://woocommerce.com/document/self-service-dashboard-for-woocommerce-subscriptions/)
...
- Related briefs:
  - A123 — Payment and Address Updates in a Subscription Portal
  - A125 — When to Create a WooCommerce Subscription Manually
  - A126 — Editing an Active WooCommerce Subscription Safely
...
The existing self-service switch recipe owns configuration. Verify current Free plan-switching behavior and Pro entitlement dependencies.

...
After the policy and QA matrix pass, connect the catalog rules to the broader [ArraySubs WooCommerce membership system](/product/arraysubs/features/woocommerce-membership/), then [review Pro pricing](/product/arraysubs/pricing/) if automatic billing or advanced controls are needed.

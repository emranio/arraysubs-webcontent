...
const ALL_FEATURES = "/product/arraysubs/features/";
const MEMBERSHIP_FEATURE =
  "/product/arraysubs/features/woocommerce-membership/";

/**
 * Shared template for the 15 `/product/arraysubs/features/<slug>/` pillar pages.
...
export function PillarDetail({ pillar }: { pillar: FeaturePillar }) {
  const path = `/product/arraysubs/features/${pillar.slug}/`;
                ...
                <div className="mt-6 grid gap-[0.1875rem] sm:grid-cols-2 lg:grid-cols-3">
                  {relatedPillars.map((related) => (
                    <TagCard
                      ...
                      href={`/product/arraysubs/features/${related.slug}/`}

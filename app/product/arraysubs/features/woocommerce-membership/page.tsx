...
const PATH = "/product/arraysubs/features/woocommerce-membership/";
const PRICING = "/product/arraysubs/pricing/";
const MEMBER_ACCESS = "/product/arraysubs/features/member-access-control/";
    ...
    <>
      <PageHero
        breadcrumbs={[
          ...
          { name: "Features", href: "/product/arraysubs/features/" },
      ...
      <Section id="membership-features" surface="surface" spacing="md">
        <Container>
          ...
          <div className="mt-8 flex justify-center">
            <Button
              href="/product/arraysubs/features/subscriptions-and-recurring-products/"
              variant="outline"
              size="sm"
              iconRight={<ArrowRight className="size-4" />}
            >
          ...
          <div className="grid gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button
                  href="/product/arraysubs/features/customer-portal/"
                  variant="dark"
                  size="sm"
                  iconRight={<ArrowRight className="size-4" />}
                >
                ...
                <Button
                  href="/product/arraysubs/features/profile-builder/"
                  variant="outline"
                  size="sm"
                >
      ...
      <Section surface="default" spacing="md">
        <Container>
          <MediaFeature
            ...
            actions={
              <Button
                href="/product/arraysubs/features/manage-subscriptions/"
                variant="outline"
                size="sm"
                iconRight={<ArrowRight className="size-4" />}
              >
      ...
      <Section surface="surface" spacing="md">
        <Container>
          <MediaFeature
            ...
            actions={
              <Button
                href="/product/arraysubs/features/retention-flow-builder/"
                variant="outline"
                size="sm"
                iconRight={<ArrowRight className="size-4" />}
              >
          ...
          <div className="mt-12 grid gap-[0.1875rem] sm:grid-cols-2 lg:grid-cols-4">
            {relatedUseCases.map((useCase) => (
              <IconCard
                ...
                href={`/product/arraysubs/use-cases/${useCase.slug}/`}
              />
            ))}
          </div>
        </Container>

...
/**
 * Shared template for every `/product/arraysubs/use-cases/recipes/<slug>/` page.
    ...
    <>
      <PageHero
        breadcrumbs={[
          ...
          { name: "Use cases", href: "/product/arraysubs/use-cases/" },
          {
            name: recipe.name,
            href: `/product/arraysubs/use-cases/recipes/${recipe.slug}/`,
          },
        ]}
        title={recipe.h1}
                ...
                <div className="mt-6 grid gap-[0.1875rem] sm:grid-cols-2 lg:grid-cols-3">
                  {relatedRecipes.map((item) => (
                    <IconCard
                      ...
                      href={`/product/arraysubs/use-cases/recipes/${item.slug}/`}
                      badge={
